    ...
    <div className="flex flex-row justify-center mt-8">
      <div className="flex flex-col gap-y-8 w-full">
        ...
        <div className="flex flex-col md:flex-row mx-auto w-4/5 gap-x-12 gap-y-8">
          <SettingsButton
            icon={<div className="p-6 rounded-lg bg-gradient-to-tr from-vermillion to-lilac">
          ...
          />
          <SettingsButton
            icon={<div className="p-6 rounded-lg bg-gradient-to-tr from-mint-green to-cyan">
